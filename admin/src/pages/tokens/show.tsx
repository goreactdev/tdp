...
export const SBTTokensShow: React.FC<IResourceComponentsProps> = () => {
  ...
  return (
    <Show isLoading={isLoading}>
      ...
      <Title level={5}>Index</Title>
      <NumberField value={record?.index ?? ""} />
      <Title level={5}>Created At</Title>
            <TextField value={new Date(record?.created_at * 1000 ?? "").toLocaleString("ru-RU", {
                year: "numeric",
                month: "numeric",   
                day: "numeric",
            })} />
            <Title level={5}>Updated At</Title>
            <TextField value={new Date(record?.updated_at * 1000 ?? "").toLocaleString("ru-RU", {
                year: "numeric",
                month: "numeric",   
                day: "numeric",
            })} />
